...
duracion_promedio_com = np.average(array_comedia[:,0]) #todas las filas (:) de la columna 0
print(round(duracion_promedio_com, 2))

print("\n-- Puntaje promedio de las peliculas de COMEDIA --")
puntaje_promedio_com = np.average(array_comedia[:,2]) #todas las filas (:) de la columna 0
...
duracion_promedio_acc = np.average(array_accion[:, 0]) #todas las filas (:) de la columna 0
print(round(duracion_promedio_acc, 2))

print("\n-- Puntaje promedio de las peliculas de ACCION --")
puntaje_promedio_acc = np.average(array_accion[:,2]) #todas las filas (:) de la columna 0
...
duracion_promedio_dra = np.average(array_drama[:, 0]) #todas las filas (:) de la columna 0
print(round(duracion_promedio_dra, 2))

print("\n-- Puntaje promedio de las peliculas de DRAMA --")
puntaje_promedio_dra = np.average(array_drama[:,2]) #todas las filas (:) de la columna 0
...
bin_array = np.arange(1980, 2021, 10)
